...
OLLAMA_ORIGINS="https://fqa.info,https://ollama.fqa.info,http://localhost:5173" OLLAMA_HOST=0.0.0.0:11434 ollama serve > ollama.log 2>&1 &
sleep 3
...
echo "Tunnel URL: https://ollama.fqa.info"
echo ""
